...
class AddEditVPNDialog(QDialog):
    def __init__(self, parent=None, existing_names=None, vpn: Optional[VPNProfile] = None):
        ...
        general_form.addRow("", self.use_saml_cb)
        ...
        self.use_saml_cb.stateChanged.connect(self._update_auth_fields)
    ...
    def should_forget_password(self) -> bool:
        return self._should_forget_password or self.use_saml_cb.isChecked()
...
class VPNProcess:
    ...
    def _ensure_routes(self):
        ...
        for raw in routes:
            ...
            for target, is_v6 in targets:
                ...
                if self._run_privileged(cmd, purpose="adjust custom routes"):
    ...
    def _cleanup_routes(self):
        for target, interface, is_v6 in self._applied_routes:
            ...
            self._run_privileged(cmd, purpose="remove custom routes")
        self._applied_routes.clear()
